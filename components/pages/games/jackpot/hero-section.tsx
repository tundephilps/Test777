          ...
          <div className="">
            ...
            <div className="mb-6">
              <p
                ...
                style={{ fontFamily: "var(--font-bounded)" }}
              >
                {t("hero_winning_chance")}
              </p>
            </div>

            {/* <Countdown targetTime="2025-12-30T23:59:59" /> */}

            <button className="flex cursor-pointer mt-4 items-center space-x-1 bg-linear-to-b from-[#f80507] to-[#860001] hover:opacity-90 px-24 py-2.5 rounded-md text-white font-medium transition">
