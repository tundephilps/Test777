        ...
        <div className="mb-8">
          ...
          <div className="grid lg:grid-cols-3 gap-6 mb-8">
            <div className="text-center bg-[#0b2231] p-4 rounded-md ">
              ...
              <div className="text-slate-400 text-sm">{t("balance")}</div>
            </div>
            ...
            <div className="text-center bg-[#0b2231] p-4 rounded-md">
              ...
              <div className="text-slate-400 text-sm">{t("level")}</div>
            </div>

            <div className="text-center bg-[#0b2231] p-4 rounded-md">
              <div className="text-3xl font-bold text-white mb-1">Jan 2025</div>
              <div className="text-slate-400 text-sm">{t("joined")}</div>
            </div>
          </div>
          ...
          <div className="mb-3 bg-[#0b2231] p-4 rounded-md">
            ...
            <p className="text-slate-400 lg:text-sm text-xs">
              {t("wager")} <span className="text-slate-300">$3,000</span>{" "}
              {t("moreToReach")}{" "}
              <span className="text-slate-300">{t("goldTier")}</span>
            </p>
          </div>
        </div>
      </div>
