    ...
    <div className="bg-[#0A1F2D] text-white mx-auto px-6 py-8 rounded-lg  border border-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              >
                <option value="BTC">BEP-20</option>
              </select>
      ...
      <div className="mt-8 p-4 bg-red-500/5 border border-red-500/20 rounded-lg">
        <p className="text-xs text-slate-400 leading-relaxed">
          ...
          you are sending <span className="text-white font-bold">BNB</span> over
          the correct network. Sending any other currency to this address may
