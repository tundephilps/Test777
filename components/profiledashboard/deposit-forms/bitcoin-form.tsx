  ...
  return (
    <div className="bg-[#0A1F2D] text-white mx-auto px-6 py-8 rounded-lg  border border-slate-800">
      ...
      <div className="flex items-center gap-4 mb-6">
        <div className="w-16 h-16 bg-[#F7931A] rounded-full flex items-center justify-center shadow-lg">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="LN">Lightning Network</option>
      ...
      <div className="mt-8 p-4 bg-red-500/5 border border-red-500/20 rounded-lg">
        <p className="text-xs text-slate-400 leading-relaxed">
          ...
          you are sending{" "}
          <span className="text-white font-bold">Bitcoin (BTC)</span> over the
          correct network. Sending any other currency to this address may result
...
export default BitcoinDepositForm;
