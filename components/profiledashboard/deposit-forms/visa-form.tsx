  ...
  return (
    <div className="bg-[#0A1F2D] text-white mx-auto px-6 py-8 rounded-lg  border border-slate-800">
      ...
      <div className="flex items-center gap-3 mb-6">
        <h2 className="text-3xl font-extrabold italic text-[#2563EB]">VISA</h2>
      ...
      <form className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full bg-[#0a1f33] border border-[#162e44] rounded-lg px-4 py-3 focus:outline-none focus:border-[#0051FF] transition-colors placeholder-slate-600"
          />
        </div>
      ...
      <div className="mt-6 flex justify-center gap-4 opacity-40 grayscale">
        {/* You can add small security icons here if needed */}
...
export default VisaDepositForm;
