...
export const GameCard: React.FC<GameCardProps> = ({
  ...
  const handleFavorite = (e: React.MouseEvent) => {
    ...
    console.log("GameCard handleFavorite clicked!", {
      gameId: game.id,
  ...
  return (
    <div className="relative group overflow-hidden rounded-lg transition-all hover:-translate-y-1 duration-300">
      ...
      <button
        ...
        className="cursor-pointer hidden lg:flex absolute top-2 right-2 p-2 rounded-full bg-black/40 hover:bg-black/60 transition-colors z-20"
      ...
      <button
        ...
        className="cursor-pointer lg:hidden absolute bottom-2 right-2 bg-black/70 text-white p-2 rounded-full z-20 hover:bg-black/90 transition-colors"
